...
$app->get('/activities/:keyboard',  
		...
		//$app->get('/activity/:idActivity',  'getActivity');
$app->get('/activity/:idActivity',  
        function ($idActivity) use ($api) {
           $api->getActivity($idActivity);
        });
		//$app->get('/activities/',  'getAllActivities');


		//$app->get('/activity/',  'getTypeActivity');
$app->get('/activity/',  
        function () use ($api) {
           $api->getAllActivities();
        });
		...
		//$app->get('/picact/:idActivity',  'getPhotosActivites');
$app->get('/picact/:idActivity',  
        function () use ($api) {
           $api->getPhotosActivites();
        });
...
$app->delete(
    ...
    function ($Id) {
		$api = new API();
		$api->delActivity($Id);
        //echo 'This is a DELETE route'.$Id;
    }
);
		//$app->get('/products/:idActivity','getProducts');
$app->get('/products/:idActivity',  
        function () use ($api) {
           $api->getProducts();
        });
				
//$app->get('/rdv/:idActivity','getRDV');
$app->get('/rdv/:idActivity',  
        function () use ($api) {
           $api->getRDV();
        });
//Login route

$app->get('/admin/:mail/:passwd',  
        function ($mail, $passwd) use ($api) {
